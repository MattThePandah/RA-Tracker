// Lightweight genre heuristics based on title keywords
// Not perfect, but useful to filter large libraries without IGDB genres.
...
export function collectGenres(games=[]) {
  ...
  for (const g of games) {
    for (const gen of detectGenres(g.title || '')) set.add(gen)
  }
